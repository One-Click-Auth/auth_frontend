...
const Users: React.FC = () => {
  ...
  const org_id =
    '36940c08c5f3492bb544e1efa2b3b4d584927dbe241111ee88069dc8f7663e88';
  ...
  const getData = () => {
    fetch(
      `https://api.trustauthx.com/org/all/users?org_id=${org_id}&start=0&limit=9999999`,
      {
        method: 'GET',
        headers: headers
      }
        ...
        return (
          <>
            {user.loading ? (
              ...
              <Switch
                checked={user.s === true ? true : false}
